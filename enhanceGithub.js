...
if (window.location.href.indexOf('/files') !== -1) {
    ...
    buttonDiv.className = 'diffbar-item';
...
if (window.location.href.indexOf('/pulls') !== -1) {
    ...
    buttonAll.className = 'js-selected-navigation-item subnav-item';
    buttonAll.append(document.createTextNode('All'));
    var buttonNew = document.createElement('a');
    buttonNew.className = 'js-selected-navigation-item subnav-item';
